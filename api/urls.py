...
urlpatterns = [    
    ...
    path('enrollment/', EnrollmentView.EnrollmentList.as_view(), name='Enrollment List'),
    path('enrollment/<int:pk>/', EnrollmentView.EnrollmentDetail.as_view(), name='Enrollment Detail'),
]
